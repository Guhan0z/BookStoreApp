...
@DataJpaTest(properties = {"spring.datasource.url=jdbc:tc:postgresql:16-alpine:///db"})
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@Sql("/test_data.sql")
// @Import(TestcontainersConfiguration.class) If there are multiple containers configures it would unnecessarily spin-up
// those
class CatalogRepositoryTest {
    ...
    void shouldReturnProductByCode() {
        ProductEntity productEntity = catalogRepository.findByCode("P107").orElseThrow();
