...
//                .log().everything()
    ...
    void shouldGetProductByCode() {
        ProductDTO product = when()
                .get("/api/products/P103")
                .then()
//                .log().everything()
                .statusCode(200)
                .assertThat()
        ...
        assertThat(product.description()).isEqualTo("Gone with the Wind is a novel written by Margaret Mitchell, first published in 1936.");
